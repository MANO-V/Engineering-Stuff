...
public class eee_sem2_ct_units extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
         view=inflater.inflate(R.layout.eee_sem2_ct_units,container,false);
    ...
    private void Question_Papers() {
        ...
        question.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ref1=storageReference1.child("EEE/SEM II/EE8251 - CIRCUIT THEORY/EE8251 - CIRCUIT THEORY.pdf");
                ...
                ref1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri)
                    {
                        ...
                        downloadflie(getActivity(), "EE8251 - CIRCUIT THEORY PREVIOUS YEAR QUESTION PAPER", ".pdf",url);
    ...
    private void Notes() {
        ...
        Notes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ref=storageReference.child("EEE/SEM II/EE8251 - CIRCUIT THEORY/EE8251 - CIRCUIT THEORY.pdf");
                ...
                ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri)
                    {
                        ...
                        Toast.makeText(getActivity(),"Downloading",Toast.LENGTH_SHORT).show();
                        String url=uri.toString();
                        downloadflie(getActivity(), "EE8251 - CIRCUIT THEORY", ".pdf",url);
