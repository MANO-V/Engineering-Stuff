...
public class eee_sem6_es_units extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
         view=inflater.inflate(R.layout.eee_sem6_es_units,container,false);
    ...
    private void Question_Papers() {
        ...
        question.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ref1=storageReference1.child("EEE/SEM VI/EE8691 - EMBEDDED SYSTEMS/EE8691 - EMBEDDED SYSTEMS.pdf");
                ...
                ref1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri)
                    {
                        ...
                        downloadflie(getActivity(), "EE8691 - EMBEDDED SYSTEMS PREVIOUS YEAR QUESTION PAPER", ".pdf",url);
    ...
    private void Notes() {
        ...
        Notes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ref=storageReference.child("EEE/SEM VI/EE8691 - EMBEDDED SYSTEMS/EE8691 - EMBEDDED SYSTEMS.pdf");
                ...
                ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri)
                    {
                        ...
                        Toast.makeText(getActivity(),"Downloading",Toast.LENGTH_SHORT).show();
                        String url=uri.toString();
                        downloadflie(getActivity(), "EE8691 - EMBEDDED SYSTEMS", ".pdf",url);
